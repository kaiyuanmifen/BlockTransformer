...
def generator(config):
    ...
    ####test and val are from the same distribution as train 
    val_classes = classes[:num_train:3]
    test_classes = classes[0:num_train:3]
    ####OOD test set has compositional different distribution
    OODtest_classes = classes[num_train+num_val:]
    ...
    split_classes = [train_classes, val_classes, test_classes,OODtest_classes]
    # print("train_classes")
    # print(train_classes)
    # print("val_classes")
    # print(val_classes)
    ...
    # print(test_classes)
    count = 1
    for i, split_name in enumerate(['train', 'val', 'test',"OODtest"]):
        ...
        for j, current_class in enumerate(split_classes[i]):
            ...
            class_path=path #do not use sub folder , making it easier for loader
