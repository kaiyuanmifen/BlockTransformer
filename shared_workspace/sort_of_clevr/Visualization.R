...
ggplot(data = Data, aes(x=Episode, y=Ternary_accuracy,linetype=Method,colour=Method)) +
  geom_smooth(size=2)



ggplot(data = Data, aes(x=Episode, y=Relations_accuracy,linetype=Method,colour=Method)) +
  geom_smooth(size=2)
