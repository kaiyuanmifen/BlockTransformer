...
from model import RN, CNN_MLP, Transformer,PerceiverModel
...
parser.add_argument('--model', type=str, choices=['RN', 'CNN_MLP', 'Transformer',"Perceiver"], default='RN', 
...
parser.add_argument('--Method', type = str, default = "Vanilla",help="which transformer encoder to use")
...
if __name__ == "__main__":
	...
	for epoch in range(1, args.epochs + 1):
		...
		fields=[epoch, train_acc_ternary, train_acc_binary,
						 train_acc_unary, test_acc_ternary, test_acc_binary, test_acc_unary]
		with open(f'{args.save_dir}/{args.model}_{args.seed}_{args.Method}_log.csv', 'a') as f:
			writer = csv.writer(f)
